    ...
    for file, participant in zip(files, part):
        ...
        for n_cycle in n_cycles:
            ...
            for i in range(batch_size):
                ...
                identifier.initialize_problem(
                    model_path,
                    p_mapping_list,
                    with_residual_torques=with_residual_torque,
                    threads=1,
                    weights=weights_tmp,
                    scaling_factor=(1, (1, 1, 1), 1),
                    emg_names=emg_names,
                    all_muscle_len=MTU_len,
                    l_norm_bounded=True,
                    p_init=None,
                ...
                print(
                    f"Optimization for participant {participant} and trial {trial_short} is done for batch {i} and cycles {n_cycle}"
                )
