...
if __name__ == '__main__':
    ...
    for file, participant in zip(files, participants):
        ...
        f"/mnt/shared/Projet_hand_bike_markerless/process_data/P10/result_biomech_gear_20_for_params_new_mvc.bio"
        ...
        file_path = prefix + f"/Projet_hand_bike_markerless/process_data/{participant}" + f"/result_biomech_{trial_short}_for_params_new_mvc.bio"
