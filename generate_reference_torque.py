...
if __name__ == '__main__':
    ...
    files, participants = get_all_file(participants, data_dir, trial_names=trials, to_include=["gear_20"],
    ...
    for file, participant in zip(files, participants):
        ...
        file_path = prefix + f"/Projet_hand_bike_markerless/process_data/{participant}" + f"/result_biomech_{trial_short}_with_technical_marker.bio"
        output_path = prefix + f"/Projet_hand_bike_markerless/optim_params/reference_data/{participant}" + f"/reference_torque_{trial_short}_with_technical_marker.bio"
