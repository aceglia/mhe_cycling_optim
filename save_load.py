...
if __name__ == "__main__":
    ...
    data_markers = get_created_data_from_pickle(
        "/home/lim/Documents/Stage_Antoine/Antoine_Leroy/Optimization/sandbox/cycling/markers_g_pedalage_1.pkl"
    )
    ...
    data_emg = get_created_data_from_pickle(
        "/home/lim/Documents/Stage_Antoine/Antoine_Leroy/Optimization/sandbox/cycling/emg_g_pedalage_1.pkl"
    )
    data_emg = data_emg[:13, :]
    data_q = get_created_data_from_pickle(
        "/home/lim/Documents/Stage_Antoine/Antoine_Leroy/Optimization/sandbox/cycling/q_recons/q_recons_pedalage_scaled_model.pkl"
    )
    data_qdot = get_created_data_from_pickle(
        "/home/lim/Documents/Stage_Antoine/Antoine_Leroy/Optimization/sandbox/cycling/q_recons/q_dot_recons_pedalage_scaled_model.pkl"
    )
